      ...
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:gap-4 sm:px-6">
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-3">
          ...
          <button
            onClick={onRescrape}
            disabled={running}
            className="group flex items-center gap-2 rounded-full bg-ink px-4 py-2 font-mono text-[11px] font-medium uppercase tracking-[0.14em] text-paper transition-all hover:bg-pine active:scale-[0.97] disabled:opacity-60"
          >

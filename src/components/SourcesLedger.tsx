...
const CHIP: Record<Row["status"], string> = {
  ...
  snapshot: "bg-amber-soft text-amber border-amber/50",
    ...
    <section className="mt-16 sm:mt-20">
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <p className="max-w-xs text-[13px] leading-relaxed text-ink-soft">
          Each source is a standalone n8n workflow writing to Postgres; the feed service
          serves the merged JSON. Scraping is managed from the Control Room and the master
          scheduler.
        </p>
      </div>
